 ...
 */
public class DepartmentsFragment extends SherlockFragment
{
    private View _fragmentView;
    private String server = LoginActivity.local_address;
    private String url_page_en = server + "//UIMS/Help/departments/departments.html";
//    private String url_page_ru = server + "//UIMS/Help/departments/ru.html";
//    private String url_page_kg = server + "//UIMS/Help/departments/kg.html";
//    private String url_page_tr = server + "//UIMS/Help/departments/tr.html";
...
//        String foot;
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog.setMessage("Departments web content is loading..");
...
//            TextView header_text = (TextView) getSherlockActivity().findViewById(R.id.notification_head);
            TextView body_text = (TextView) getSherlockActivity().findViewById(R.id.departments_body);
...
//            footer_text.setText(Html.fromHtml(foot));
    ...
    {
        _fragmentView = inflater.inflate(R.layout.departments_layout, container, false);
